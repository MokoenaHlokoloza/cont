...
public class JwtUtil {
    ...
    private String createToken(Map<String, Object> claims, String subject) {
        return Jwts.builder()
                ...
                .setExpiration(new Date(System.currentTimeMillis() + jwtExpirationMs))  // Token expiration in 10 hours
                .signWith(SignatureAlgorithm.HS256, SECRET_KEY)  // Using HS256 algorithm for signing
                .compact();
    }
