...
public class RepaymentControllerTest {
    ...
    public void testCalculateRepaymentOptions_Success() throws Exception {
        ...
        when(repaymentService.calculateRepaymentOptions(any())).thenReturn(options);
        ...
        verify(repaymentService).calculateRepaymentOptions(any());
    }
    ...
    public void testCalculateRepaymentOptions_EmptyResponse() throws Exception {
        ...
        when(repaymentService.calculateRepaymentOptions(any())).thenReturn(new ArrayList<>());
